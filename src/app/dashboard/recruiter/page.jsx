...
const RecruiterDashboardHomePage = () => {
    ...
    if (isPending) {
        return <div>Loading... <span className='loading loading-spinner loading-xl'></span> </div>
    }
    ...
    return (
        <div>
            <h2 className="text-4xl">Welcome back, <span className='capitalize'>{user?.name}</span></h2>
